...
namespace APIVerve
{
    public class AirportsLookupAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/airports";
        ...
        public AirportsLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public AirportsLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AirportsLookupQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(AirportsLookupQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(AirportsLookupQueryOptions options)
        {
