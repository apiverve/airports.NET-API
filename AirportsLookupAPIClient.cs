...
namespace APIVerve
{
    public class AirportsLookupAPIClient
    {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, airportsQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(airportsQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(airportsQueryOptions options)
        {
